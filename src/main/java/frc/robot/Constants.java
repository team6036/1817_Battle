...
public class Constants {
    ...
    public static class SwerveConstants {
        ...
        public static double FRo = 0;
        public static double FLo = 0;
        public static double BRo = 0;
        public static double BLo = 0;

        public static class FR {
            public static final int D = 4;
            public static final int T = 3;
            public static final int E = 10;
            public static final double offset = 2.727418 + Math.PI + FRo - (Math.PI/180)*8 + FLo;
        }
        ...
        public static final class BR {
            ...
            public static final double offset = 0.632000 - 0.47123889 + 2.819764 + BRo;
        }
        ...
        public static final class BL {
            ...
            public final static double offset = 0.878971 + Math.PI*2 - Math.PI/2 +  Math.PI/2 + Math.PI + BLo;
        }
    }
